...
class GettingStarted{
    ...
    private AlgodClient connectToNetwork() {
        ...
        this.client = new AlgodClient(ALGOD_API_ADDR,
    ...
    public static void main(String args[]) throws Exception {
        ...
        t.connectToNetwork();
        Account account=new Account("seek churn spider car author kick purity obey winner truck project sketch eyebrow wink pistol aspect blush hobby river left kick attack topple absorb deposit");
        System.out.println(account.getAddress());
        t.printBalance(account);
